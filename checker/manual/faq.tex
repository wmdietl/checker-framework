...
\\ \ref{faq-vararg-syntax-meaning}: What is the meaning of vararg annotations such as \<@English String @NonEmpty ...>?
...
\subsection{What is the meaning of vararg annotations such as \<@English String @NonEmpty ...>?\label{faq-vararg-syntax-meaning}}

Vararg annotations are treated similarly to array annotations.
...
the vararg list must not be empty.
...
%%  LocalWords:  OtherClass 8's Goetz antipattern subclassed
