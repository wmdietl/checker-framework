...
public class JavaLangStrictMath {
    ...
    void inverseTrigIdentitiesTest() {
        // full list of identities http://www.sosStrictMath.com/trig/Trig5/trig5/trig5.html
    ...
    void powTest() {
        ...
        @mm2 double mm2 = StrictMath.pow(mm, 2);
        @km2 double km2 = StrictMath.pow(km, 2.0);
        @Scalar double gRaised2 = StrictMath.pow(g, 2.0);
        //:: error: (assignment.type.incompatible)
        s = StrictMath.pow(m, 2);
        //:: error: (assignment.type.incompatible)
        s = StrictMath.pow(mm, 2);
        //:: error: (assignment.type.incompatible)
        s = StrictMath.pow(km, 2.0);
        //:: error: (assignment.type.incompatible)
        s = StrictMath.pow(g, 2.0);

        // raised to any other power for m, mm, and km returns Scalar (Future TODO: support for m3, mm3, km3, etc)
        @Scalar double m3 = StrictMath.pow(m, 3);
        @Scalar double mm3 = StrictMath.pow(mm, 3);
        @Scalar double km3 = StrictMath.pow(km, 3.0);
        @Scalar double gRaised3 = StrictMath.pow(g, 3.0);
        //:: error: (assignment.type.incompatible)
        ...
        @Scalar double m4 = StrictMath.pow(m, g);
        //:: error: (assignment.type.incompatible)
        @m2 double m4bad = StrictMath.pow(m, g);
    }
